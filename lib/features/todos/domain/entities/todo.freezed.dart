...
extension TodoPatterns on Todo {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(int userId, int id, String title, bool completed)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Todo() when $default != null:
        return $default(_that.userId, _that.id, _that.title, _that.completed);
      case _:
        return orElse();
    }
  }
  ...
  TResult when<TResult extends Object?>(
    TResult Function(int userId, int id, String title, bool completed) $default,
  ) {
    final _that = this;
    switch (_that) {
      case _Todo():
