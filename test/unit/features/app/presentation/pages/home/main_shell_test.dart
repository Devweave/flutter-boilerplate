...
void main() {
  group('MainShell Widget Tests', () {
    ...
    testWidgets('should show bottom navigation bar with correct items', (tester) async {
      // Act
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should have navigation tabs that are tappable', (tester) async {
      // Act
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should have proper styling for custom navigation bar', (tester) async {
      // Act
      await tester.pumpWidget(createTestWidget());
      await tester.pumpAndSettle();
    ...
    testWidgets('should have animated icon switching', (tester) async {
      ...
      expect(find.byType(AnimatedSwitcher), findsNWidgets(2)); // One for each nav item
    ...
    testWidgets('should have proper container padding for nav items', (tester) async {
      // Act
      await tester.pumpWidget(createTestWidget(
        child: const Center(child: Text('Test Child')),
      ));
      ...
      // Check padding
      for (int i = 0; i < 2; i++) {
        final container = tester.widgetList<Container>(navItemContainers).elementAt(i);
        expect(container.padding, equals(const EdgeInsets.symmetric(horizontal: 20)));
      }
    });

    testWidgets('should center nav items with proper alignment', (tester) async {
      // Act
      await tester.pumpWidget(createTestWidget(
        child: const Center(child: Text('Test Child')),
      ));
